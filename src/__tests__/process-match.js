...
describe('process-match', () => {
  ...
  it('should process a match with a match_id', async () => {
    ...
    expect(elastic.indexDocs.mock.calls[0][2]).toEqual(['team', 'team_id', 'game', 'game_id'])
    expect(elastic.indexDocs.mock.calls[1][2]).toEqual(['player', 'player_id', 'game', 'game_id'])
