...
const rawQuery = require('./stats/raw-query')
const filterQuery = require('./stats/filter-query')
...
// router.post('/stats/player_games', rawQuery(`player_games`))
// router.get('/stats/player_games', filterQuery(`player_games`))
// router.post('/stats/team_games', rawQuery(`team_games`))
// router.get('/stats/team_games', filterQuery(`team_games`))
